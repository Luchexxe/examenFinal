...
function eje8(personas, empresa) {
...
const res=eje8(personas, "EmpresaX");
console.log(res);

const res2=eje8(personas, "Empresa ZZZ");
console.log(res2);

const res3=eje8(personas, "Empresa ABC");
console.log(res3);


const res4=eje8(personas, "Pepitos & Asoc");
console.log(res4);
