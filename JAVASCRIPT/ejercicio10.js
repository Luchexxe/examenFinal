...
class Alumno extends Persona{
    ...
    constructor(nombre,edad,profesion,catedral,nivel)
    {
    super(nombre,edad,profesion);
    this.#catedral=catedral;
    this.#nivel=nivel;
    ...
    get getCatedral()
    {
    return this.#catedral;       
    }

    set setCatedral(catedral)
    {
        if(typeof catedral === 'string')
        {
            if(catedral.length>=5)
            {
                this.#catedral=catedral;
            }
            else
...
//const pers = new Persona("Luis",30);
//console.log(pers.getNombre +" "+ pers.getEdad +" "+ pers.getProfesion);
//pers.setProfesion="ing";
//console.log(pers.getNombre +" "+ pers.getEdad +" "+ pers.getProfesion);
//console.log(pers.quienSoy());

const alumno = new Alumno("Luis",30,"ing","catedra",1);
console.log(alumno.getNombre +" "+ alumno.getEdad+" "+ alumno.getProfesion +" "+ alumno.getCatedral +" " + alumno.getNivel);
alumno.setCatedral="cated";
console.log(alumno.getNombre +" "+ alumno.getEdad+" "+ alumno.getProfesion +" "+ alumno.getCatedral +" " + alumno.getNivel);
alumno.setNivel=1;
console.log(alumno.getNombre +" "+ alumno.getEdad+" "+ alumno.getProfesion +" "+ alumno.getCatedral +" " + alumno.getNivel);