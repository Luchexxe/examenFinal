...
//* Crear una funcion que reciba el objeto "c" establecido aquí arriba y retornar un booleano indicando si la cantidad total de alumnos indicada es igual a la sumatoria
//* de todos los alumnos de todas las catedras.



function eje5(c) {
  let alumCated = c.profesores.reduce((acum, valor) => {
    return acum + valor.catedras.reduce((acum2, valor2) => {
      return acum2 + valor2.alumnos;
    }, 0);
  }, 0);

  return c.cantidadAlumnos === alumCated;
}
